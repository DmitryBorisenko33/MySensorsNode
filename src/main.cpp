...
void loop() {
    ...
    sendMsgFastAck(1, V_TEMP, random(1000, 1500), false);
    sendMsgFastAck(2, V_TEMP, random(100, 150), false);
    sendMsgFastAck(3, V_CUSTOM, fatalErrors, false);
    sendMsgFastAck(4, V_CUSTOM, totalErrors, true);  // у последнего сообщения в loop должно стоять true, у остальных false
    SerialPrintln("==============================================");
}
